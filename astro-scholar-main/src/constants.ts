...
export const SITE_DATA = {
    ...
    tagline: "Mathematics & Statistics Student @ McMaster University",
    ...
    description: "Mathematics & Statistics student at McMaster University with hands-on experience in SQL, R, Python, Machine Learning, Tableau, Power BI, ETL Pipelines, and GCP (BigQuery). Proven ability to gather, clean, analyze, and visualize data to support data-driven decision-making. Seeking an Analyst or Data Science role where I can apply a strong quantitative foundation to deliver business insights.",
